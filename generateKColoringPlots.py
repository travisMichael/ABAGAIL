...
def test_best():
    ...
    problem_size_list, _, ga_best_score_list = load_ga("KColoring/GA_Stats_salesman_cross_over.txt", 5)
    _, _, mimic_best_score_list = load_mimic("KColoring/MIMIC_Stats.txt", 5)

    # best_scores = [rhc_best_score_list, sa_best_score_list, ga_best_score_list, mimic_best_score_list]
    best_scores = [ga_best_score_list, mimic_best_score_list]
...
def plot_evaluations():
    # problem_size_list, _, rhc_best_score_list = load_rhc("KColoring/RHC_Stats.txt", 1)
    # _, _, sa_best_score_list = load_sa("KColoring/SA_Stats.txt", 4)
    problem_size_list, _, ga_best_score_list = load_ga("KColoring/GA_Stats_salesman_cross_over.txt", 1)
    _, _, mimic_best_score_list = load_mimic("KColoring/MIMIC_Stats.txt", 1)
